...
I'm a third-year Engineering Physics undergraduate at IIT Patna, working on GenAI and multi-agent systems.
My recent projects use LangGraph to orchestrate multiple specialized LLM agents into a single coherent
workflow — from AI-driven appointment scheduling to automated trip planning — combining state-machine
design with LLM reasoning, retrieval, and structured tool use.
</p>
...
<table align="center">
  <tr>
    <td><b>Currently building with</b></td>
    <td>LangGraph, LangChain, RAG pipelines, Gemini, Groq-hosted LLaMA models</td>
  </tr>
  <tr>
    <td><b>Currently exploring</b></td>
    <td>Agentic workflows, retrieval-augmented generation, quantum computing</td>
  </tr>
  <tr>
    <td><b>Goal</b></td>
    <td>Ship working agents. Solve hard problems. Repeat.</td>
  </tr>
</table>
...
|---|---|---|
| Hackathon | National Software Hackathon | Finalist among 100,000+ candidates |
| Competitive Programming | LeetCode / Codeforces | 450+ problems solved (DP, Trees, Heaps) |
| Olympiad | National Science Olympiad | AIR 378 |
| Certification | NxtWave ANN Bootcamp | ANN architecture, backpropagation, model optimization |
| Certification | freeCodeCamp Python Certification | DSA and core programming fundamentals |
| Education | IIT Patna | B.Tech, Engineering Physics |
...
A conversational AI scheduling platform built on a 9-node LangGraph state machine, with a Supervisor and 4 specialized agents (Info, Booking, Cancellation, Rescheduling) handling the full appointment lifecycle. Uses Gemini for intent classification and 7 custom LangChain tools to manage 4,280+ appointment slots for 10 doctors across 7 specializations.
...
A 4-agent LangGraph pipeline (flight, hotel, itinerary, synthesis) coordinated by Groq-accelerated LLaMA3.3-70B for parallelized trip planning. Includes a deterministic NLP heuristic over 28,000+ global airports to resolve ambiguous locations into IATA codes, exposed through a 4-endpoint FastAPI backend with PostgreSQL-backed checkpointing.
